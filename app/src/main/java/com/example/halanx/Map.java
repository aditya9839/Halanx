...
public class Map extends Fragment implements OnMapReadyCallback {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        CustomMapView mapView = view.findViewById(R.id.mapview);
        mapView.onCreate(savedInstanceState);
        mapView.onResume();
        mapView.getMapAsync(this);
        Button mget_directions = view.findViewById(R.id.get_directions);
        ...
        Button mopen_in_google_maps = view.findViewById(R.id.open_in_google_maps);
...
//        CameraUpdate cameraUpdate = CameraUpdateFactory.newLatLngZoom(latLng, 11);
        ...
        googleMap.addMarker(new MarkerOptions()
                ...
                .position(latLng).icon(BitmapDescriptorFactory.fromBitmap(resizeMapIcons())));

//            map.moveCamera(CameraUpdateFactory.newLatLngZoom(23,0));

    }
    private Bitmap resizeMapIcons(){
        Bitmap imageBitmap = BitmapFactory.decodeResource(getResources(),getResources().getIdentifier("marker_icon", "drawable", Objects.requireNonNull(getActivity()).getPackageName()));
